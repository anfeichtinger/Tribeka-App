...
class ShiftScreenState extends State<ShiftScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final _errorText = AnimatedOpacity(
      ...
      child: ConstrainedBox(
          constraints: BoxConstraints(
              minWidth: 50, maxWidth: MediaQuery.of(context).size.width / 3),
          child: Text(
            _errorMsg,
    ...
    final _hoursTile = ListTile(
        ...
        title: const Text('Stunden', style: TextStyle(fontSize: 16)),
    ...
    final _placeTile = ListTile(
        ...
        title: const Text('Lokal', style: TextStyle(fontSize: 16)),
